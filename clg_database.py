...
main = Tk()
main.title('Sangamner College')
main.geometry('1000x600')
main.resizable(0, 0)

# Creating the background and foreground color variables
lf_bg = '#1a1919' # bg color for the left_frame
cf_bg = '#383837' # bg color for the center_frame
...
Label(main, text="SANGAMNER COLLEGE", font=headlabelfont, bg='#000000',fg="white").pack(side=TOP, fill=X)
...
right_frame = Frame(main, bg="#1a1919")
...
Label(right_frame, text='Students Records', font=headlabelfont, bg='#1a1919', fg='white').pack(side=TOP, fill=X)
